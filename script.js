...
function showSection(sectionId) {
  ...
  document.getElementById('menu-icon').addEventListener('click', () => {
    ...
    document.getElementById('background-anniversary').classList.add('hidden');
    document.querySelector('.background').classList.remove('no-gradient');
   });
  
  // Button for anniversary 
  document.getElementById('anniversary-button').addEventListener('click', () => {
    ...
    document.getElementById('background-anniversary').classList.remove('hidden');
    document.querySelector('.background').classList.add('no-gradient');
 ...
 function showMainMenu() {
    ...
    document.getElementById('dates-button').style.display = 'block';
    document.getElementById('gifts-button').style.display = 'block';
