...
document.getElementById('menu').addEventListener('click', () => {
  ...
  document.getElementById('valentine-background').classList.add('hidden');
...
// Acción para el botón "My Valentine💓"
document.getElementById('valentine-button').addEventListener("click", () => {
  // Remover la clase 'hidden' del fondo si existe
  document.getElementById('valentine-background').classList.remove('hidden');

  // Ocultar todos los botones principales excepto "Yes" y "No"
  ...
  // Mostrar la sección Valentine
  document.getElementById('valentine-section').style.display = 'block';
});

// Variable para controlar que la foto se muestre solo una vez
let photoShown = false;

// Acción para el botón "Yes"
document.getElementById('yes-button').addEventListener("click", () => {
  if (!photoShown) {
    // Crear y mostrar la foto solo una vez
    const photo = document.createElement("img");
    photo.src = "images/buggs.png";  // Reemplaza con la ruta de tu foto
    photo.alt = "Foto de mi Valentine";
    photo.style.width = "100%"; // Ajusta el tamaño según necesites
    photo.style.borderRadius = "10px";
    document.getElementById('valentine-section').appendChild(photo);
    photoShown = true;
  }
});

// Acción para el botón "No" que muestra una alerta en la parte superior
document.getElementById('no-button').addEventListener("click", function() {
  // Crear o mostrar la alerta "Respuesta incorrecta"
  let alertElement = document.getElementById('alerta');
  if (!alertElement) {
    alertElement = document.createElement('div');
    alertElement.id = 'alerta';
  ...
  alertElement.innerText = 'Respuesta incorrecta';
